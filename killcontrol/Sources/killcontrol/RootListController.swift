...
class RootListController: PSListController {
    ...
    override func viewDidLoad() {
        ...
        if let icon = UIImage(named: "/Library/PreferenceBundles/killcontrol.bundle/PrefIcon.png") {
    ...
    override func readPreferenceValue(_ specifier: PSSpecifier!) -> Any! {
        let path = "/User/Library/Preferences/com.ginsu.killcontrol.plist"
